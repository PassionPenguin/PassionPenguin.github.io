...
![](../images/native-splash-screen-in-flutter-using-lottie.md-1*4vlkTJCWbP2Kh2vyK9BdEw.png)
...
![Android 项目目录](../images/native-splash-screen-in-flutter-using-lottie.md-1*kj2sZaD-YWBgNaEXYAwqbg.png)

这就是 Android 下 Lottie 构建 Splash 启动页的方法，只需要跑一下这个应用程序然后你就能够看到应用程序启动时候的动画了。

![Android 中使用了动画的 Splash 页面](../images/native-splash-screen-in-flutter-using-lottie.md-1*EDVg6zpUrwJ39ppvlN7nTA.gif)
...
![添加一个新的 View Controller](../images/native-splash-screen-in-flutter-using-lottie.md-1*L9EKQQFnxtozE_xgcpVkfw.png)

3. 完成了第二步之后，你会看到两个屏幕。选择新的 View Controller 然后点击 `attributes inspector`，然后再点击 `is initial view controller` .

![设置 Splash View Controller 为起始的 View Controller](../images/native-splash-screen-in-flutter-using-lottie.md-1*TzWohD3MyARxjm7Vetmzow.png)
...
![设置 Main interface 为 Main](../images/native-splash-screen-in-flutter-using-lottie.md-1*KQV8lIB3aRfA_AHtTNXi4g.png)

生成并运行该应用程序，你应该能够看到动画的启动页了：

![](../images/native-splash-screen-in-flutter-using-lottie.md-1*bdfeeBtOIHW_1A0MfdjnZQ.gif)
