...
The **R****endering** panel is another useful tool. To open the Rendering panel, use `CMD`+`Shift`+`P` again, type “rendering” this time, and choose the “Show Rendering” option. This tool has many options, but my favorite ones are:
