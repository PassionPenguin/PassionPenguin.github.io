...
![使用 Android 11 进行机器学习：新功能](../images/machine-learning-with-android-11-whats-new.md-1*_6zTCa-SeOV2q549ey3b5Q.jpeg)
...
![设备上 ML 背后的理念](../images/machine-learning-with-android-11-whats-new.md-1*O1a_Su6P-XggXk9IXTSzMQ.jpeg)
...
![Android Studio 中的导入模型选项](../images/machine-learning-with-android-11-whats-new.md-1*fnNNyLYKqafERAjUfwPsxQ.jpeg)
...
![查看模型元数据](../images/machine-learning-with-android-11-whats-new.md-1*ZHuSORcTLhxtSWr60TzxWA.jpeg)
...
![tfhub.dev 上的一些发布者](../images/machine-learning-with-android-11-whats-new.md-0*cv-fzgw2WPuf4PQI.png)

![TF Hub 中的过滤器](../images/machine-learning-with-android-11-whats-new.md-1*Cu-XiVrzOi2MdKatQ1dpzw.png)
